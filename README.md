...
Adaptation of the original DOOM to be easily portable to framebuffer devices as well as SDL2, Raylib or X11-compatible systems.
...
Backends:
* SDL2: software rendering with accelerated scaling, sound + music
* Raylib: software rendering with accelerated scaling, no sound
